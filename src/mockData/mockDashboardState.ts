...
const suggestedTests: ChangedFile[] = [
...
export function createMockDashboardState(mode: DashboardMode = "liveChanges", selectedFeatureId = "motion-planning"): DashboardState {
  return {
    mode,
    workspace: {
      name: "ABB_ROS2",
...
function edge(from: string, to: string, kind: DependencyEdge["kind"] = "import"): DependencyEdge {
  return {
    from,
    to,
    kind,
...
function changed(
  ...
  featureId: string,
  moduleId: string,
  riskLevel: ChangedFile["riskLevel"],
  reason: string,
...
function impacted(
  featureId: string,
  label: string,
  riskLevel: ImpactedFeature["riskLevel"],
  reason: string,
  changedFileCount: number,
...
function validation(id: string, label: string, state: ValidationStatus["state"], detail: string): ValidationStatus {
  return {
    id,
    label,
    state,
...
function overviewCards(): MetricCard[] {
  return [
...
function healthCards(): HealthCard[] {
  return [
...
function diffSummaryCards(): MetricCard[] {
  return [
...
function liveImpactGraph(): GraphModel {
  return {
    width: 1120,
    height: 360,
    nodes: [
...
function dependencyGraph(): GraphModel {
  return {
    width: 700,
    height: 330,
    nodes: [
...
function wholeArchitectureGraph(): GraphModel {
  return {
    width: 1120,
    height: 430,
    nodes: [
...
function featureInternalGraph(): GraphModel {
  return {
    width: 640,
    height: 330,
    nodes: [
...
function baselineBeforeGraph(): GraphModel {
  return diffGraph(false);
}

function baselineAfterGraph(): GraphModel {
  return diffGraph(true);
}

function diffGraph(after: boolean): GraphModel {
...
function circleNode(id: string, label: string, x: number, y: number, riskLevel: "low" | "medium" | "high") {
  return {
    id,
    label,
    x,
...
function topChanges(): DiffChangeRow[] {
  return [
