...
export function createMockDashboardState(
  ...
  selectedFeatureId = "motion-planning"
): DashboardState {
...
export function createMockSnapshot(): WorkspaceSnapshot {
  return {
...
export function getFeatureById(featureId: string): FeatureBlock | undefined {
...
function edge(
  from: string,
  to: string,
  kind: "import" | "config" | "test" | "entrypoint" | "unknown" = "import",
